          ...
          onTap: () {
            if (!context.read<UserProvider>().isLogined) {
              ...
              try {
                if (widget.listApiType == "1365") {
                  launchUrl(Uri.parse(
                      'https://www.1365.go.kr/vols/1572247904127/partcptn/timeCptn.do?type=show&progrmRegistNo=${3018351}'));
                } else if (widget.listApiType == "vms") {
                  launchUrl(Uri.parse(
                      'https://www.vms.or.kr/partspace/recruitView.do?seq=${3018351}'));
                }
                Navigator.pop(context);
              } catch (e) {
                print("URL 열기 에러: $e");
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    // ),
                    Text(
                      "활동 장소: ${widget.actPlace} (${widget.locationStr})",
                      style: const TextStyle(
                        color: Color.fromARGB(255, 124, 123, 123),
                        fontSize: 12.0,
                        height: 2.8,
